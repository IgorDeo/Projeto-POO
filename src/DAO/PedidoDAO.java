...
public class PedidoDAO {
    ...
    public void cadastrarPedido(String idCliente, String idFuncionario, String total, int tamanhoTabela, PedidoBeans pedidoB){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao Salvar Registro", "Erro", 0, new ImageIcon(getClass().getResource("/Icones/ico_sair.png")));
            }
   ...
   public void cadastrarItens(String idCliente, String idFuncionario, String idPedido, int tamanhoTabela, PedidoBeans pedidoB){
       for (int i = 0; i < tamanhoTabela; i++) {
           ...
           try {
               ...
               JOptionPane.showMessageDialog(null, "Erro ao Cadastrar Item", "Erro", 0, new ImageIcon(getClass().getResource("/Icones/ico_sair.png")));
           }
       }
   }
}